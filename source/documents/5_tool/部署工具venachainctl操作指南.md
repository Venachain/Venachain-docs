...
- 关于Venachain部署中涉及的一些名词解释与部署环境的目录结构，请见 [**文档《Venachain部署介绍》**](../2_deploy/Venachain部署介绍.md) 。
...
在单机上部署一个单节点的链。**部署后的目录结构请看** [**文档《Venachain部署介绍》**](../2_deploy/Venachain部署介绍.md) 。 
...
在单机上部署一个四节点的链。**部署后的目录结构请看** [**文档《Venachain部署介绍》**](../2_deploy/Venachain部署介绍.md) 。 
...
- **部署相关的名词解释和部署环境的目录结构请看** [**文档《Venachain部署介绍》**](../2_deploy/Venachain部署介绍.md) 。
