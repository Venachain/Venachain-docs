...
| 版本 | 更新内容 | 更新人 | 更新日期 |
| --- | --- | --- | --- |
| 0.1 | 新建 | 庄建涵、毛智凯 | 44697 |
| 0.2 | 增加背景描述、上链方式等信息 | 毛智凯 | 44712 |
| 0.3 | 补全每个接口出现的错误码 | 庄建涵 | 44720 |
| 0.4 | 合约接口文档调整 | 毛智凯 | 44720 |
| 0.5 | 交易发送，from 改为非必填 | 毛智凯 | 44732 |
| 0.6 | 所有接口对链相关过滤，关键字均为 chainName | 毛智凯 | 44732 |
| 0.7 | 新版本功能接口调整 | 毛智凯 | 44762 |
