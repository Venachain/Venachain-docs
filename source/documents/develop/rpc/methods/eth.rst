...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_gasPrice","params":[],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_protocolVersion","params":[],"id":1}' "http://127.0.0.1:6791"
...
- ``object | bool`` : 同步状态对象或false。同步对象的结构如下：
    ...
    + currentBlock ``quantity`` : 节点当前正在同步的区块的块高，同 :ref:`eth_blockNumber <rpc-eth-blockNumber>`
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_syncing","params":[],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_chainId","params":[],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_blockNumber","params":[],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getBalance","params":["0x8fa786734bfcb8351be33a4168dd5530ddd7578f", "0x8"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getAccountBaseInfo","params":["0x8fa786734bfcb8351be33a4168dd5530ddd7578f", "0x8"],"id":1}' "http://127.0.0.1:6791"
...
请参考 :ref:`eth_getBlockByHash <rpc-eth-getBlockByHash>` 的返回值。
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getBlockByNumber","params":["0x8", true],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getBlockByHash","params":["0x9bc44f307452f977546449b83d9f42dbf12ebff8145b55e603764757bb89fbe8", true],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getCode","params":["0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b","0xb"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getStorageAt","params":["0x295a70b2de5e3953354a6a8344e616ed314d7251","0x0", "latest"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getStorageAt","params":["0x295a70b2de5e3953354a6a8344e616ed314d7251","0x6661e9d6d8b923d5bbaab1b96e1dd51ff6ea2a93520fdc9eb75d059238b8c5e9", "latest"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_call","params":[{"from":"0x054c138b7ed3083ee9a36e1b09542fccdc155d75","to":"0x0000000000000000000000000000000000000011","gas":"0x106000","gasPrice":"0x0","value":"0x1","data":""},"0x8"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_estimateGas","params":[{"gas":"0x106000","gasPrice":"0x0","value":"0x1","data":""}],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getBlockTransactionCountByNumber","params":["0x1"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getBlockTransactionCountByHash","params":["0x8188ed673fec3050184d2afe7b2c562f920ac97145ebc566ade868e6a450ae91"],"id":1}' "http://127.0.0.1:6791"
...
请参考 :ref:`eth_getTransactionByHash <rpc-eth-getTransactionByHash>` 的返回值。
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getTransactionByBlockNumberAndIndex","params":["0x1", "0x2"],"id":1}' "http://127.0.0.1:6791"
...
查阅 :ref:`eth_getTransactionByHash <rpc-eth-getTransactionByHash>` 的返回值
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getTransactionByBlockHashAndIndex","params":["0x8188ed673fec3050184d2afe7b2c562f920ac97145ebc566ade868e6a450ae91", "0x2"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getRawTransactionByBlockNumberAndIndex","params":["0x1", "0x2"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getRawTransactionByBlockHashAndIndex","params":["0x8188ed673fec3050184d2afe7b2c562f920ac97145ebc566ade868e6a450ae91", "0x2"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getTransactionCount","params":["0xf92ce14220d5c938342651a43c14a311ae37f43b", "0x3"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getTransactionByHash","params":["0x2955c837a4aafe976f9fe37904c62b23fa8eff08d592bae598a1fd930036ec92"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getRawTransactionByHash","params":["0x2955c837a4aafe976f9fe37904c62b23fa8eff08d592bae598a1fd930036ec92"],"id":1}' "http://127.0.0.1:6791"
...
.. _rpc-eth-getTransactionReceipt:
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getTransactionReceipt","params":["0x2955c837a4aafe976f9fe37904c62b23fa8eff08d592bae598a1fd930036ec92"],"id":1}' "http://127.0.0.1:6791"
...
当创建合约时，在交易生效后，请使用 :ref:`eth_getTransactionReceipt <rpc-eth-getTransactionReceipt>` 调用获取合约地址。
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_sendTransaction","params": [{"from":"0xf92ce14220d5c938342651a43c14a311ae37f43b","to":"0xf92ce14220d5c938342651a43c14a311ae37f43b","gas":"0x76c0","gasPrice":"0x9184e72a000","value":"0x0","data":""}],"id":1}' "http://127.0.0.1:6791"
...
当创建合约时，在交易生效后，请使用 :ref:`eth_getTransactionReceipt <rpc-eth-getTransactionReceipt>` 获取合约地址。
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d  '{"jsonrpc":"2.0","method":"eth_sendRawTransaction","params":["0xf86c8516306402898609184e72a0008276c094f92ce14220d5c938342651a43c14a311ae37f43b808082027ba0a95b1e4570cfcba6d53789fa3db85e7ad2a746aa43cd29a62b7c0355f6886d29a061b0f7b5ab98ab078b86cd3e1a1f3ccc56f829983ae06bce27f1d38d9dabc5e4"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_sign","params":["0xf92ce14220d5c938342651a43c14a311ae37f43b", "0xdeadbeaf"],"id":1}' "http://127.0.0.1:6791"
...
- ``object`` : 交易对象，详情请查看 :ref:`eth_sendTransaction <rpc-eth-sendTransaction>`
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_signTransaction","params":[{"from":"0xf92ce14220d5c938342651a43c14a311ae37f43b", "to":"0xf92ce14220d5c938342651a43c14a311ae37f43b", "gas":"0x76c0", "nonce":"0x1630640289", "gasPrice":"0x9184e72a000", "value":"0x0", "data":""}],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_pendingTransactions","params":[],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_pendingTransactionsLength","params":[],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_resend","params":[{"from":"0xf92ce14220d5c938342651a43c14a311ae37f43b", "to":"0xd46e8dd67c5d32be8058bb8eb970870f07244567", "gas":"0x76c0", "nonce":"0x3", "gasPrice":"0x9184e72a000", "value":"0x9184e72a", "data":"0xd46e8dd67c5d32be8d46e8dd67c5d32be8058bb8eb970870f072445675058bb8eb970870f072445675"},"0x9184e72a005", "0x9184e72a0a0"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_accounts","params":[],"id":1}' "http://127.0.0.1:6791"
...
.. _rpc-eth-newPendingTransactionFilter:

eth_newPendingTransactionFilter [websocket]
===================================================

在节点中创建一个监听 **pending交易** 产生的过滤器，当产生新的 pending 交易时进行通知。
要检查状态是否发生变化，请调用 :ref:`eth_getFilterChanges <rpc-eth-getFilterChanges>`
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_newPendingTransactionFilter","params":[],"id":1}' "http://127.0.0.1:6791"
...
.. _rpc-eth-newBlockFilter:

eth_newBlockFilter [websocket]
====================================

在节点中创建一个监听 **新区块** 产生的过滤器，当新区块生成时进行通知。要检查状态是否变化，请调用 :ref:`eth_getFilterChanges <rpc-eth-getFilterChanges>`
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_newBlockFilter","params":[],"id":1}' "http://127.0.0.1:6791"
...
基于给定的选项创建一个过滤器对象，当状态发生变化时进行通知。要检查状态是否变化，请调用 :ref:`eth_getFilterChanges <rpc-eth-getFilterChanges>`
...
- ``object`` : 过滤器选项对象
    + blockhash ``data`` : 可选，由 :ref:`eth_getLogs <rpc-eth-getLogs>` 使用，仅从具有此哈希的块返回日志。
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_newFilter","params":[{"topics":["0x000000000000000000000000a94f5374fce5edbc8e2a8697c15331677e6ebf0b"]}],"id":1}' "http://127.0.0.1:6791"
...
- ``object`` : 过滤器对象，请参考 :ref:`eth_newFilter <rpc-eth-newFilter>` 调用的参数
...
请参考 :ref:`eth_getFilterChanges <rpc-eth-getFilterChanges>`
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST --data '{"jsonrpc":"2.0","method":"eth_getLogs","params":[{"topics":["0x000000000000000000000000a94f5374fce5edbc8e2a8697c15331677e6ebf0b"]}],"id":1}' "http://127.0.0.1:6791"
...
卸载指定哈希的过滤器。当不再需要监听时，总是需要执行该调用。另外，过滤器如果在一定时间内未接收到 :ref:`eth_getFilterChanges <rpc-eth-getFilterChanges>` 调用会自动超时。
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_uninstallFilter","params":["0x49f265419399903a285d325aa8955866"],"id":1}' "http://127.0.0.1:6791"
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getFilterLogs","params":["0x1d72025d3166c71be2cd4dbb413ede5b"],"id":1}' "http://127.0.0.1:6791"

- 响应

请参考 :ref:`eth_getFilterChanges <rpc-eth-getFilterChanges>`

.. _rpc-eth-getFilterChanges:
...
1) 使用 :ref:`eth_newBlockFilter <rpc-eth-newBlockFilter>` 创建的过滤器将返回块哈希（32字节），例如 ``["0x3454645634534..."]`` 。
2) 使用 :ref:`eth_newPendingTransactionFilter <rpc-eth-newPendingTransactionFilter>` 创建的过滤器将返回交易哈希(32字节)，例如 ``["0x6345343454645..."]`` 。
3) 使用 :ref:`eth_newFilter <rpc-eth-newFilter>` 创建的过滤器，日志对象具有如下参数：
...
.. code:: sh
    ...
    curl -H "Content-Type: application/json" -X POST -d '{"jsonrpc":"2.0","method":"eth_getFilterChanges","params":["0x1d72025d3166c71be2cd4dbb413ede5b"],"id":1}' "http://127.0.0.1:6791"
